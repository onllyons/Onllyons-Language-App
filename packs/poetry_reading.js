...
export default function PoetryReading({navigation}) {
    ...
    const handleBookmark = useCallback(() => {
        sendDefaultRequest(
            `${SERVER_AJAX_URL}/poetry/create_bookmark.php`,
            {id: id},
            navigation,
            {success: false}
        )
        ...
        const newData = getStoredValue("books_poetry", true)
        ...
        setStoredValueAsync("books_poetry", newData)
            .then(() => {})
            .catch(() => {})
    ...
    const handleFinish = useCallback(() => {
        sendDefaultRequest(
            `${SERVER_AJAX_URL}/poetry/finish_poetry.php`,
            {id: id},
            navigation,
            {success: false}
        )
