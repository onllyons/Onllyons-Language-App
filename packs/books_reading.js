...
export default function BooksScreen({navigation}) {
    ...
    useMemo(() => {
        ...
        sendDefaultRequest(`${SERVER_AJAX_URL}/books/get_book.php`,
            {id: bookId},
            navigation,
            {success: false}
        )
            .then((data) => {
                const words = extractWords(data.data.content); // Presupunând că `data.data.content` conține HTML-ul
    ...
    const handleBookmark = () => {
        sendDefaultRequest(`${SERVER_AJAX_URL}/books/create_bookmark.php`,
            {id: bookId},
            navigation,
            {success: false}
        )
    ...
    return (
        <GestureHandlerRootView style={styles.container}>
            ...
            <ScrollView onScroll={handleScroll} scrollEventThrottle={4}
                        contentContainerStyle={{paddingTop: 30, paddingBottom: 30, paddingHorizontal: 20,}}>
